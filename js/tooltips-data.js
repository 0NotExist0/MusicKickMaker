/**
 * KickForge 303 - Dizionario Completo Spiegazioni e Consigli per Controlli Audio
...
export const CONTROL_TOOLTIPS = {
  ...
  // ==========================================
  // MODULO 1: ATTACCO 303 & FISCHIO ACIDO
  // ==========================================
  attack303_cutoff: {
    title: "APERTURA 303 (Cutoff Filtro)",
  ...
  attack303_resonance: {
    title: "ACIDITÀ & FISCHIO (Resonance 303)",
  ...
  attack303_envMod: {
    title: "TAGLIO ACUTO (Inviluppo Filtro)",
  ...
  attack303_decay: {
    title: "DURATA FISCHIO (Attack Decay)",
  ...
  attack303_pitch: {
    title: "ALTEZZA NOTA 303 (Attack Pitch)",
  ...
  attack303_drive: {
    title: "CATTIVERIA GRANA (Pre-Drive Diodo)",
  ...
  // ==========================================
  // MODULO 2: CORPO & PUGNO NELLO STOMACO
  // ==========================================
  body_startFreq: {
    title: "PICCO INIZIALE (Start Frequency)",
  ...
  body_punchFreq: {
    title: "PUGNO PUNCH (Punch Frequency)",
  ...
  body_tailFreq: {
    title: "NOTA DEL BASSO (Tail Root Note)",
  ...
  body_punchDecay: {
    title: "VELOCITÀ BOTTA (Punch Decay)",
  ...
  body_tailDecay: {
    title: "LUNGHEZZA CODA (Tail Decay)",
  ...
  fm_amount: {
    title: "TIMBRO METALLICO (FM Amount)",
  ...
  fm_ratio: {
    title: "ARMONICI METALLO (FM Ratio)",
  ...
  // ==========================================
  // MODULO 3: BASSI SUB & RIMBOMBO WAREHOUSE
  // ==========================================
  sub_boost: {
    title: "SPINTA SUBWOOFER (Sub Weight)",
  ...
  rumble_volume: {
    title: "RIMBOMBO RAVE (Rumble Mix)",
  ...
  rumble_decay: {
    title: "DURATA RIMBOMBO (Rumble Decay)",
  ...
  rumble_cutoff: {
    title: "CALORE RIMBOMBO (Rumble Filter)",
  ...
  rumble_ducking: {
    title: "PULIZIA BOTTA (Sidechain Ducking)",
  ...
  // ==========================================
  // MODULO 4: DISTORSIONE HARDCORE & TONO
  // ==========================================
  drive_amount: {
    title: "SATURAZIONE FUOCO (Overdrive)",
  ...
  fold_amount: {
    title: "GRATTATA ESTREMA (Wavefolder)",
  ...
  eq_low: {
    title: "BASSI PESANTI (Low Shelf EQ)",
  ...
  eq_midFreq: {
    title: "ZONA FREQUENZA MEDI (Mid EQ Freq)",
  ...
  eq_high: {
    title: "TAGLIO ACUTO (High Shelf EQ)",
  ...
  master_gain: {
    title: "VOLUME USCITA (Master Gain)",
